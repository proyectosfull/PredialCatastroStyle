<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="catMesa.aspx.cs" Inherits="Catastro.Catalogos.catMesa" %>
        ...
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td style="height: 60px;">
                        <asp:Label ID="Label1" runat="server" Text="Mesas" CssClass="letraTitulo"></asp:Label>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:Button ID="btnNuevo" runat="server" OnClick="btnNuevo_Click"
                                        Text="Nueva Mesa" CausesValidation="False" />
                                </td>
                                <td>&nbsp;</td>
                            </tr>
            ...
            <asp:Panel ID="pnl" runat="server" class="formPanel">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td colspan="4">
                            <asp:Label ID="lbl_titulo" runat="server" CssClass="textModalTitulo2" Text="Alta o Edición de la Mesa"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 307px; height: 41px;">
                            <asp:TextBox ID="txtNombre" runat="server" CssClass="textExtraGrande" MaxLength="100" placeholder="Nombre(s)" Width="273px"></asp:TextBox>
