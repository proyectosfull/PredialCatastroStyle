...
{
    public partial class catParametroSistema : System.Web.UI.Page
    {
        ...
        {
            ddlFiltro.DataSource = new cParametroSistemaBL().ListaCampos();
            ddlFiltro.DataBind();
        ...
        private void llenagrid()
        {
          string[] filtro =  (string[])ViewState["filtro"];
            ...
            if (filtro == null)
            {
                grd.DataSource = new cParametroSistemaBL().GetFilter("", "", "TRUE", ViewState["sortCampo"].ToString(), ViewState["sortOnden"].ToString());
                grd.DataBind();
            }
            else
            {
                grd.DataSource = new cParametroSistemaBL().GetFilter(filtro[0], filtro[1], filtro[2], ViewState["sortCampo"].ToString(), ViewState["sortOnden"].ToString());
                grd.DataBind();
        ...
        protected void grd_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                lbl_titulo.Text = "Consulta Parámetro de Sistema";
                pnl_Modal.Show();
                int id = Convert.ToInt32(e.CommandArgument);
                cParametroSistema cParametroSistema = new cParametroSistemaBL().GetByConstraint(id);
                limpiaCampos();
                habilitaCampos(false);
                ///txtClave.Text = cParametroSistema.Clave;
                txtValor.Text = cParametroSistema.Valor;
                txtDescripcion.Text = cParametroSistema.Descripcion;
                btnGuardar.Visible = false;
            }
          else if (e.CommandName == "ModificarRegistro")
            {
                lbl_titulo.Text = "Modifica Parámetro de Sistema";
                int id = Convert.ToInt32(e.CommandArgument);
                cParametroSistema cParametroSistema = new cParametroSistemaBL().GetByConstraint(id);
                limpiaCampos();
                habilitaCampos(true);
        ...
        //{
        //    lbl_titulo.Text = "Alta de Nuevo Parámetro de Sistema";
        //    pnl_Modal.Show();
        //    limpiaCampos();
        //    habilitaCampos(true);
        //    btnGuardar.Visible = true;
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                cParametroSistema cParametroSistema = new cParametroSistema();
                //cParametroSistema.Clave = txtClave.Text;
                cParametroSistema.Valor = txtValor.Text;
                cParametroSistema.Descripcion = txtDescripcion.Text;
                cParametroSistema.IdUsuario = U.Id;
                cParametroSistema.Activo = true;
                cParametroSistema.FechaModificacion = DateTime.Now;
                MensajesInterfaz msg = new cParametroSistemaBL().Insert(cParametroSistema);
                vtnModal.ShowPopup(new Utileria().GetDescription(msg), ModalPopupMensaje.TypeMesssage.Alert);
            }
            else
            {
                cParametroSistema cParametroSistema = new cParametroSistemaBL().GetByConstraint(Convert.ToInt32(ViewState["idMod"]));
                //cParametroSistema.Clave = txtClave.Text;
                cParametroSistema.Valor = txtValor.Text;
                cParametroSistema.Descripcion = txtDescripcion.Text;
                cParametroSistema.IdUsuario = U.Id;
                cParametroSistema.FechaModificacion = DateTime.Now;
                MensajesInterfaz msg = new cParametroSistemaBL().Update(cParametroSistema);
                vtnModal.ShowPopup(new Utileria().GetDescription(msg), ModalPopupMensaje.TypeMesssage.Alert);
            }
        ...
        protected void vtnModal_eventoAceptar(object sender, EventArgs e)
        {
            ...
            {
                cParametroSistema cParametroSistema = new cParametroSistemaBL().GetByConstraint(Convert.ToInt32(ViewState["idMod"]));
                cParametroSistema.Activo = false;
                cParametroSistema.IdUsuario = U.Id;
                cParametroSistema.FechaModificacion = DateTime.Now;
                MensajesInterfaz resul = new cParametroSistemaBL().Delete(cParametroSistema);               
            ...
            else if (vtnModal.Mensaje == new Utileria().GetDescription(MensajesInterfaz.ActivarRegistro))
            {
                ...
                cParametroSistema.IdUsuario = U.Id;
                cParametroSistema.FechaModificacion = DateTime.Now;
                MensajesInterfaz resul = new cParametroSistemaBL().Update(cParametroSistema);                
                vtnModal.ShowPopup(new Utileria().GetDescription(resul), ModalPopupMensaje.TypeMesssage.Alert);
                ViewState["idMod"] = 0;
                llenagrid();
            }
