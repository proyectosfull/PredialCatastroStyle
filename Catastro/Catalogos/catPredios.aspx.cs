...
namespace Catastro.Catalogos
{
    public partial class catPredios : System.Web.UI.Page
    {
        ...
        private void llenaListas()
        {
            ...
            ddlUsoSuelo.DataTextField = "Descripcion";
        ...
        private void llenaConfiguracion(int Id)
        {
            ...
            txtConstribuyente.Text = predio.cContribuyente.ApellidoPaterno.Trim() + " " + predio.cContribuyente.ApellidoMaterno.Trim() + " " + predio.cContribuyente.Nombre.Trim() + " " + predio.cContribuyente.RazonSocial.Trim();
            ViewState["idContribuyente"] = predio.IdContribuyente;
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            hdfContribuyente.Value = Convert.ToInt32(ViewState["idContribuyente"]).ToString();  //new cContribuyenteBL().GetByName(txtConstribuyente.Text);
            ...
            predio.CP = txtCP.Text == "" ? "0" : txtCP.Text;
            predio.ClaveAnterior = "";
            predio.Referencia = txtReferencia.Text == null ? "" : txtReferencia.Text;
            predio.Localidad = txtLocalidad.Text == "" ? " " : txtLocalidad.Text;
            ...
            predio.Zona = txtZona.Text=="" ? 1 : int.Parse(txtZona.Text);
            predio.MetrosFrente = txtMetrosFrente.Text == "" ? 10: Convert.ToDouble(txtMetrosFrente.Text);
        ...
        private void llenaFiltro()
        {
            ...
            //ddlFiltro.Items.Insert(1, new ListItem("Nombre del Contribuyente", ""));
            //ddlFiltro.Items.Insert(2, new ListItem("Domicilio", ""));
            pnl_Modal.Show();
        }
        ...
        protected void grd_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "ActivarRegistro")
            {
                ...
                txtConstribuyente.Text = Contribuyente.RazonSocial.Trim()+" "+ Contribuyente.ApellidoPaterno.Trim() + " " + Contribuyente.ApellidoMaterno.Trim() + " "+ Contribuyente.Nombre.Trim() ;//***
                hdfContribuyente.Value = Contribuyente.Id.ToString();
                ViewState["idContribuyente"] = Contribuyente.Id;
                pnl_Modal.Hide();
            }
        ...
        protected void btnGuardarContribuyente_Click(object sender, EventArgs e)
        {
            ...
            Contribuyente.RazonSocial = txtRazon.Text == null ? "" : txtRazon.Text;
            Contribuyente.Nombre = txtNombre.Text == null ? "" : txtNombre.Text;
            Contribuyente.ApellidoPaterno = txtApellidoP.Text == null ? "" : txtApellidoP.Text;
            Contribuyente.ApellidoMaterno = txtApellidoM.Text == null ? "" : txtApellidoM.Text;
            Contribuyente.Calle = txtCalleN.Text == null ? "" : txtCalleN.Text;
            Contribuyente.Numero = txtNumeroN.Text == null ? "S/N" : txtNumeroN.Text;
            Contribuyente.Colonia = txtColoniaN.Text == null ? "" : txtColoniaN.Text;
            Contribuyente.Localidad = txtLocalidadN.Text == null ? "" : txtLocalidadN.Text;
            Contribuyente.Municipio = txtMunicipio.Text == null ? "" : txtMunicipio.Text;
            Contribuyente.Estado = txtEstado.Text == null ? "" : txtEstado.Text;
            Contribuyente.CP = txtCPN.Text == null ? "" : txtCPN.Text;
            Contribuyente.Email = txtEmail.Text == null ? "" : txtEmail.Text;
            Contribuyente.Telefono = txtTelefono.Text == null ? "" : txtTelefono.Text;
            Contribuyente.Curp = txtCurp.Text == null ? "" : txtCurp.Text;
            ...
            Contribuyente.IdTipoContribuyente  = 1;
            Contribuyente.Referencia = txtReferencia.Text == null ? "" : txtReferencia.Text;
            msg = new cContribuyenteBL().Insert(Contribuyente);
            if (msg.Equals(MensajesInterfaz.Ingreso))
            {
                txtConstribuyente.Text = txtRazon.Text +" "+txtApellidoP.Text + " " + txtApellidoM.Text + " " + txtNombre.Text;
            }
            vtnModal.DysplayCancelar = false;
        ...
        protected void rbltipoPersona_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
               // rfvApellidoPaterno.Enabled = false; nely
