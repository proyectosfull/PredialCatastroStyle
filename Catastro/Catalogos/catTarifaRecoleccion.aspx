<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="catTarifaRecoleccion.aspx.cs" Inherits="Catastro.Catalogos.catTarifaRecoleccion" %>
        ...
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td style="height: 60px;">
                        <asp:Label ID="Label1" runat="server" Text="Tarifa de Recolección" CssClass="letraTitulo"></asp:Label></td>
                </tr>
                <tr>
                    <td style="height: 2px">
                        <hr />
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:Button ID="btnNuevaCaja" runat="server" OnClick="btnNuevo_Click"
                                        Text="Nueva Tarifa de Recolección" CausesValidation="False" />
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                        </table>
            ...
            <asp:Panel ID="pnl" runat="server" class="formPanel">
                <table>
                    <tr>
                        <td colspan="5">
                            <asp:Label ID="lbl_titulo" runat="server" CssClass="textModalTitulo2" Text="Alta o Edición de la Tarifa de Recolección"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>                            
                            <asp:TextBox ID="txtEjercicio" runat="server"  MaxLength="4"  placeholder="Ejercicio."  ></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <br />
                            <asp:TextBox ID="txtTarifa" runat="server"  MaxLength="11" placeholder="Tarifa."></asp:TextBox>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <asp:RangeValidator id="RangeValidator1" runat="server" ErrorMessage="Ingresar solo números mayor a 0 y menor a 999999.9999" ControlToValidate="txtTarifa" MinimumValue="0.0001" MaximumValue="999999.9999" Display="Dynamic" Type="Double"></asp:RangeValidator>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtTarifa" CssClass="valida" ErrorMessage="Solo Números con 4 decimales Máximo." Font-Size="Small" SetFocusOnError="True" ValidationExpression="\d+(\.\d{4})?|\.\d{4}" ValidationGroup="guardar"></asp:RegularExpressionValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                 <asp:DropDownList ID="ddlTipoCobro" runat="server"></asp:DropDownList>
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlTipoCobro" InitialValue="%" CssClass="valida" ErrorMessage="*" SetFocusOnError="True" ValidationGroup="guardar"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
