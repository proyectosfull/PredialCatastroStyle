<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="catTarifaZona.aspx.cs" Inherits="Catastro.Catalogos.catTarifaZona" %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td style="height: 60px;">
                        <asp:Label ID="Label1" runat="server" Text="Tarifa Zona" CssClass="letraTitulo"></asp:Label></td>
                </tr>
                <tr>
                    <td style="height: 2px">
                        <hr />
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:Button ID="btnNuevo" runat="server" OnClick="btnNuevo_Click"
                                        Text="Nueva Tarifa Zona" CausesValidation="False" />
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                        </table>
                ...
                <table>
                    <tr>
                        <td style="width: 448px; height: 37px">
                            <asp:Label ID="lbl_titulo" runat="server" CssClass="textModalTitulo2" Text="Alta o Edición de Tarifa Zona"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                      ...
                      <tr>
                          <td style="width: 448px">
                              <asp:Label ID="lblNombre0" runat="server" CssClass="letraMediana" Text="Zona:"></asp:Label><br/>
                              <asp:TextBox ID="txtZona" runat="server" CssClass="textGrande" MaxLength="1" placeholder="Zona."></asp:TextBox>
                              <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtZona" CssClass="valida" ErrorMessage="*" SetFocusOnError="True" ValidationGroup="guardar"></asp:RequiredFieldValidator>                              
                              <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtZona" CssClass="valida" ErrorMessage="Ingresar solo números del 1 al 9" Font-Size="Small" SetFocusOnError="True" ValidationExpression="[1-9]" ValidationGroup="guardar"></asp:RegularExpressionValidator>
                          </td>
                    </tr>
                      <tr>
                        <td style="width: 448px">
                            <asp:Label ID="Label2" runat="server" Text="Tarifa:" CssClass="letraMediana"></asp:Label>
                            <br />
                            <asp:TextBox ID="txtTarifa" runat="server" CssClass="textGrande" MaxLength="11" placeholder="Tarifa."></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" CssClass="valida" ControlToValidate="txtTarifa" ErrorMessage="*" SetFocusOnError="True" ValidationGroup="guardar"></asp:RequiredFieldValidator>
                            <asp:RangeValidator id="RangeValidator1" runat="server" ErrorMessage="Ingresar solo números mayor a 0 y menor a 100" ControlToValidate="txtTarifa" MinimumValue="0.00000001" MaximumValue="99.99999999" Display="Dynamic" Type="Double"></asp:RangeValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Maximo 8 decimales." ValidationExpression="\d+(\.\d{8})?|\.\d{8}" ControlToValidate="txtTarifa" CssClass="valida" SetFocusOnError="True" ValidationGroup="guardar" Font-Size="Small"></asp:RegularExpressionValidator>
                        </td>
                    </tr>  
                    <tr>
                        <td style="width: 448px">
