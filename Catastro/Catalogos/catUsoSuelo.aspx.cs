...
{
    public partial class catUsoSuelo : System.Web.UI.Page
    {
        ...
        {
            ddlFiltro.DataSource = new cUsoSueloBL().ListaCampos();
            ddlFiltro.DataBind();
        ...
        private void llenagrid()
        {
            ...
            if (filtro == null)
            {
                grd.DataSource = new cUsoSueloBL().GetFilter("", "", "TRUE", ViewState["sortCampo"].ToString(), ViewState["sortOnden"].ToString());
                grd.DataBind();
            }
            else
            {
                grd.DataSource = new cUsoSueloBL().GetFilter(filtro[0], filtro[1], filtro[2], ViewState["sortCampo"].ToString(), ViewState["sortOnden"].ToString());
                grd.DataBind();
        ...
        protected void grd_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                lbl_titulo.Text = "Consulta Uso Suelo";
                pnl_Modal.Show();
                int id = Convert.ToInt32(e.CommandArgument);
                cUsoSuelo UsoSuelo = new cUsoSueloBL().GetByConstraint(id);
                limpiaCampos();
                habilitaCampos(false);
                txtClave.Text = UsoSuelo.Clave;
                txtDescripcion.Text = UsoSuelo.Descripcion;
                txtDensidad.Text = UsoSuelo.Densidad;
                txtLoteTipo.Text = UsoSuelo.LoteTipo;
                btnGuardar.Visible = false;
            }
            else if (e.CommandName == "ModificarRegistro")
            {
                lbl_titulo.Text = "Modifica Uso Suelo";
                int id = Convert.ToInt32(e.CommandArgument);
                cUsoSuelo UsoSuelo = new cUsoSueloBL().GetByConstraint(id);
                limpiaCampos();
                habilitaCampos(true);
        ...
        {
            lbl_titulo.Text = "Alta Uso Suelo";
            pnl_Modal.Show();
            limpiaCampos();
            habilitaCampos(true);
            btnGuardar.Visible = true;
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                cUsoSuelo UsoSuelo = new cUsoSuelo();
                UsoSuelo.Clave = txtClave.Text;
                UsoSuelo.Descripcion = txtDescripcion.Text;
                UsoSuelo.Densidad = txtDensidad.Text;
                UsoSuelo.LoteTipo = txtLoteTipo.Text;
                UsoSuelo.IdUsuario = U.Id;
                UsoSuelo.Activo = true;
                UsoSuelo.FechaModificacion = DateTime.Now;
                MensajesInterfaz msg = new cUsoSueloBL().Insert(UsoSuelo);
                vtnModal.ShowPopup(new Utileria().GetDescription(msg), ModalPopupMensaje.TypeMesssage.Alert);
            }
            else
            {
                cUsoSuelo UsoSuelo = new cUsoSueloBL().GetByConstraint(Convert.ToInt32(ViewState["idMod"]));
                UsoSuelo.Clave = txtClave.Text;
                UsoSuelo.Descripcion = txtDescripcion.Text;
                UsoSuelo.Densidad = txtDensidad.Text;
                UsoSuelo.LoteTipo = txtLoteTipo.Text;
                ...
                UsoSuelo.Activo = true;
                UsoSuelo.FechaModificacion = DateTime.Now;
                MensajesInterfaz msg = new cUsoSueloBL().Update(UsoSuelo);
                vtnModal.ShowPopup(new Utileria().GetDescription(msg), ModalPopupMensaje.TypeMesssage.Alert);
            }
        ...
        {
            txtDensidad.Enabled = activa;
            txtDescripcion.Enabled = activa;
            txtLoteTipo.Enabled = activa;
        ...
        protected void vtnModal_eventoAceptar(object sender, EventArgs e)
        {
            ...
            {
                cUsoSuelo UsoSuelo = new cUsoSueloBL().GetByConstraint(Convert.ToInt32(ViewState["idMod"]));
                UsoSuelo.Activo = false;
                UsoSuelo.IdUsuario = U.Id;
                UsoSuelo.FechaModificacion = DateTime.Now;
                MensajesInterfaz resul = new cUsoSueloBL().Delete(UsoSuelo);
                vtnModal.DysplayCancelar = true;
            ...
            else if (vtnModal.Mensaje == new Utileria().GetDescription(MensajesInterfaz.ActivarRegistro))
            {
                ...
                UsoSuelo.IdUsuario = U.Id;
                UsoSuelo.FechaModificacion = DateTime.Now;
                MensajesInterfaz resul = new cUsoSueloBL().Update(UsoSuelo);
                vtnModal.DysplayCancelar = true;
                vtnModal.ShowPopup(new Utileria().GetDescription(resul), ModalPopupMensaje.TypeMesssage.Alert);
                ViewState["idMod"] = 0;
                llenagrid();
