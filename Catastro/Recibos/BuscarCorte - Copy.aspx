...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <table cellpadding="0" cellspacing="0" width="100%">
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <asp:TextBox ID="txtBusqueda" runat="server" CssClass="textGrande" Width="240px"></asp:TextBox>
                            ...
                            <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender1" runat="server" BehaviorID="txtFiltro_MaskedEditExtender" Century="2000" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder="" InputDirection="RightToLeft" Mask="9999999999" MaskType="Number" TargetControlID="txtBusqueda" />    
        ...
        <tr>
            <td>
                 <asp:GridView ID="grdCorte" runat="server" AllowPaging="True" AutoGenerateColumns="False" BorderStyle="None" CssClass="grd" DataKeyNames="id" OnRowCommand="grdInfraccion_RowCommand" ShowFooter="True" OnPageIndexChanging="grdInfraccion_PageIndexChanging">
                            <Columns>
