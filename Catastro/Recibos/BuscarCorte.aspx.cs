...
namespace Catastro.Recibos
{
    public partial class BuscarCorte : System.Web.UI.Page
    {
        ...
        protected void grdCorte_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            grdCorte.PageIndex = e.NewPageIndex;
            llenarGrid();
        }

        protected void grdCorte_RowCommand(object sender, GridViewCommandEventArgs e)
        {
