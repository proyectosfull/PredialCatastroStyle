...
namespace Catastro.Recibos
{
    public partial class ReporteIngresos : System.Web.UI.Page
    {
        ...
        protected void imbBuscar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            List<pReporteIngresosConDescuento_Result> listIngresosConsulta = new pProcedimientos().ObtieneReporteIngresosConDescuentos(Convert.ToInt32(ddlCajero.SelectedValue),inicio, fin);
                     
            ////INICIA REPORTE
            rpt.ProcessingMode = Microsoft.Reporting.WebForms.ProcessingMode.Local;
            rpt.LocalReport.DisplayName = "Ingresos por Cajero";
            rpt.LocalReport.ReportPath = "Reportes/IngresosConsulta.rdlc";
            ...
            rpt.LocalReport.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource("IngConsulta", listIngresosConsulta));
            ...
            paramList.Add(new ReportParameter("Cajera", ddlCajero.SelectedItem.Text, false));
