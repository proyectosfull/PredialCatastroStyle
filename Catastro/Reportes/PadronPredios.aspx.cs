...
{
    public partial class PadronPredios : System.Web.UI.Page
    {
        ...
        protected void imbBuscar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            {
                litado = new vVistasBL().ObtienePadron(int.Parse(ddlStatus.SelectedValue), int.Parse(ddlAnio.SelectedValue), int.Parse(ddlBimestre.SelectedValue), int.Parse(ddlTipo.SelectedValue), "", RemoveSpecialCharacters(txtClave.Text), txtContribuyente.Text.Trim(), hdfIdCondominio.Value, txtColonia.Text, txtInicioClave.Text,txtFinClave.Text);
            }
            ...
            rpvtPredios.LocalReport.ReportPath = "Reportes/PadronPredios.rdlc";
