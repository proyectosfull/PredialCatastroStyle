<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteRecibos.aspx.cs" Inherits="Catastro.Recibos.ReporteRecibos" %>
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style="height: 60px;">
                <asp:Label ID="Label1" runat="server" Text="Reporte de Recibos." CssClass="letraTitulo"></asp:Label></td>
        </tr>
        <tr>
            <td style="height: 2px">
                <hr />
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td> 
                          ...
                          <asp:DropDownList ID="ddlTipoTramite" runat="server"></asp:DropDownList>  
                             &nbsp;&nbsp;                        
                            <asp:CheckBox ID="chkInhabilitados" Text="Inhabilitados" runat="server" Checked="True" />
                        </td>
                        <td>
                    ...
                    <tr>
                        <td  width="750px">
                             <asp:Label ID="lblCajero" runat="server" Text="Cajero(a)"></asp:Label>  &nbsp;                           
