<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="catRol.aspx.cs" Inherits="Catastro.Catalogos.catRol" %>
        ...
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" width="100%">                
                ...
                <tr>
                    <td style="height: 60px;">
                        <asp:Label ID="Label1" runat="server" Text="Roles" CssClass="letraTitulo"></asp:Label>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:Button ID="btnNuevo" runat="server" OnClick="btnNuevo_Click"
                                        Text="Nuevo Rol" CausesValidation="False" />
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                ...
                <tr>
                    <td style="padding: 0px 10px 10px 10px;">
                        <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:BoundField DataField="Rol" HeaderText="Rol" SortExpression="nombre" />
            ...
            <asp:Panel ID="pnl" runat="server" class="formPanel">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td colspan="4">
                            <asp:Label ID="lbl_titulo" runat="server" CssClass="textModalTitulo2" Text="Alta o Edición del Rol"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 307px; height: 41px;">
                            <asp:TextBox ID="txtRol" runat="server" CssClass="textExtraGrande" MaxLength="50" placeholder="Rol" Width="273px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="valida" ControlToValidate="txtRol" ErrorMessage="*" SetFocusOnError="True" ValidationGroup="guardar"></asp:RequiredFieldValidator>
                        </td>
                    </tr>                                        
                    <tr>
                        <td style="width: 105px; height: 41px;">
