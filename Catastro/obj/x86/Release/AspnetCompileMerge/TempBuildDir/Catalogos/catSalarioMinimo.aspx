<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="catSalarioMinimo.aspx.cs" Inherits="Catastro.Catalogos.catSalarioMinimo" %>
        ...
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td style="height: 60px;">
                        <asp:Label ID="Label1" runat="server" Text="UMA" CssClass="letraTitulo"></asp:Label></td>
                </tr>
                <tr>
                    <td style="height: 2px">
                        <hr />
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:Button ID="btnNuevo" runat="server" OnClick="btnNuevo_Click"
                                        Text="Nuevo UMA" CausesValidation="False" />
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                        </table>
            ...
            <asp:Panel ID="pnl" runat="server" class="formPanel">
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="lbl_titulo" runat="server" CssClass="textModalTitulo2" Text="Alta o Edición de UMA"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" Text="Importe:" CssClass="letraMediana"></asp:Label>
                            <br />
                            <asp:TextBox ID="txtImporte" runat="server" CssClass="textGrande" MaxLength="10" placeholder="Importe."></asp:TextBox>
                    ...
                    <tr>
                        <td>
                            <asp:CustomValidator ID="CustomValidator2" runat="server" ControlToValidate="txtDescripcion" CssClass="valida" ErrorMessage="Máximo 500 caracteres" ClientValidationFunction="validateLength" ValidationGroup="guardar" Font-Size="Small"></asp:CustomValidator></td>
                        </td>
                    </tr>
                    <tr>
                        <td>
