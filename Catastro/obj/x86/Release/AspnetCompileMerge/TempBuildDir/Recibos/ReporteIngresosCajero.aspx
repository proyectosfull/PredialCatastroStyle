<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteIngresosCajero.aspx.cs" Inherits="Catastro.Recibos.ReporteIngresosCajero" %>
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style="height: 60px;">
                <asp:Label ID="Label1" runat="server" Text="Reporte de ingresos por cajero." CssClass="letraTitulo"></asp:Label></td>
        </tr>
        <tr>
            <td style="height: 2px">
                <hr />
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td  width="500px">
                            ...
                            &nbsp;
                            <asp:CheckBox ID="chkConcentrado"  runat="server" Text="Concentrado" />
                        </td>
                        <td>
