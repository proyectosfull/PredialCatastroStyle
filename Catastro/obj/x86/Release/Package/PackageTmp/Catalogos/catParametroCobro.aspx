<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="catParametroCobro.aspx.cs" Inherits="Transito.Catalogos.catParametroCobro" %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td style="height: 60px;">
                        <asp:Label ID="Label1" runat="server" Text="Parámetro de cobro " CssClass="letraTitulo"></asp:Label></td>
                </tr>
                <tr>
                    <td style="height: 2px">
                        <hr />
                ...
                <tr>
                    <td style="padding: 0px 10px 10px 10px;">
                        ...
                        <asp:GridView ID="grd" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:BoundField DataField="Descripcion" HeaderText="Parámetro" SortExpression="Descripcion" />
                ...
                <table>
                    ...
                    <%--<tr>
                        <td>
                            ...
                            <br />
                            <asp:TextBox ID="txtClave" runat="server" CssClass="textGrande" MaxLength="30" placeholder="Clave." Enabled="false"></asp:TextBox>
                    ...
                    <tr>
                        <td>
                            ...
                            <br />
                            <asp:TextBox ID="txtDescripcion" runat="server" CssClass="textGrande" MaxLength="20" placeholder="Descripción."></asp:TextBox>
                    ...
                    <tr>
                        <td>
                            ...
                            <br />
                            <asp:TextBox ID="txtValor" runat="server" CssClass="textGrande" MaxLength="30" placeholder="Valor."></asp:TextBox>
