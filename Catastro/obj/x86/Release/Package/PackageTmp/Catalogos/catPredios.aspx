    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                                    ...
                                    <table style="min-width: 50%;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" CssClass="valida" ControlToValidate="ddlCondominio" ErrorMessage="*" SetFocusOnError="True" ValidationGroup="guardar"></asp:RequiredFieldValidator>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="9">
                                                <asp:TextBox ID="txtReferencia"  runat="server" MaxLength="150" CssClass="textMultiExtraGrande" placeholder="Referencia." TextMode="MultiLine"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                            ...
                            <ajaxToolkit:TabPanel ID="TabPanel2" runat="server" HeaderText="Datos Generales(2)">
                                <ContentTemplate>
                                    <table style="min-width: 50%">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblBimestreSm" visible="false" runat="server" Text="Ult Bimestre SM:" CssClass="letraMediana"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:DropDownList ID="ddlBimestreSm" visible="false" runat="server" Enabled="false">
                                                    <asp:ListItem Text="1 - Enero-Febrero" Value="1"></asp:ListItem>
                                                    <asp:ListItem Text="2 - Marzo-Abril" Value="2"></asp:ListItem>
                                                    <asp:ListItem Text="3 - Mayo-Junio" Value="3"></asp:ListItem>
                                                    <asp:ListItem Text="4 - Julio-Agosto" Value="4"></asp:ListItem>                                                  
                                            ...
                                            <td>
                                                <asp:Label ID="lblAaFinalSm" visible="false" runat="server" Text="Ult Ejercicio SM:" CssClass="letraMediana"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="txtAaFinalSm" visible="false" runat="server" CssClass="textGrande" placeholder="Ult Ejercicio SM"></asp:Label>
                                                <asp:TextBox ID="txtAaFinalSmV" visible="false" runat="server" CssClass="textGrande" placeholder="Ult Ejercicio SM" MaxLength="4" Enabled="false" ></asp:TextBox>
                                                <%--<asp:RequiredFieldValidator ID="rfvAaFinalSmV" visible="false" runat="server" CssClass="valida" ControlToValidate="txtAaFinalSmV" ErrorMessage="*" SetFocusOnError="True" ValidationGroup="guardar" Enabled="false" Visible="false"></asp:RequiredFieldValidator>
                                                <asp:RegularExpressionValidator ID="revAaFinaSmV" visible="false"  runat="server" ErrorMessage="Ingresar solo numeros enteros" ValidationExpression="^\d+$" ControlToValidate="txtAaFinalSmV" CssClass="valida" SetFocusOnError="True" ValidationGroup="guardar" Font-Size="Small" Enabled="false" Visible="false"></asp:RegularExpressionValidator>
                                                --%>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblTipoFaseSmL" visible="false" runat="server" Text="Tipo de Fase Sm:" CssClass="letraMediana"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblTipoFaseSm" visble="false"  runat="server" Text="" CssClass="letraMediana"></asp:Label>
                                                <asp:HiddenField ID="hdfTipoFaseSm" visible="false" runat="server" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="4"></td>
         ...
         <%--                           <asp:BoundField DataField="ApellidoPaterno" HeaderText="ApellidoPaterno" SortExpression="ApellidoPaterno" />
                                    ...
                                    <asp:TemplateField ItemStyle-CssClass="" HeaderText="Herramientas" ItemStyle-Width="60px">
                                        <ItemTemplate>
                    ...
                    <td style="padding: 0px 5px 5px 5px;">
                        <table>
                            <tr>
                                ...
                                <td colspan="4">
                                    <asp:Label ID="lblRazon" runat="server" Text="Razón Social:" CssClass="letraMediana"></asp:Label>
                                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                     <asp:TextBox ID="txtRazon" runat="server" CssClass="textExtraGrande" placeholder="Razon Social" MaxLength="100"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
