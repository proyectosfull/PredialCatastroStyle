<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="~/Catalogos/catTipoAsentamiento.aspx.cs" Inherits="Transito.Catalogos.catTipoAsentamiento" %>
        ...
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td style="height: 60px;">
                        <asp:Label ID="Label1" runat="server" Text="Tipo de Asentamiento" CssClass="letraTitulo"></asp:Label></td>
                </tr>
                <tr>
                    <td style="height: 2px">
                        <hr />
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td>
                                    ...
                                    <asp:Button ID="btnNuevoAsentamiento" runat="server" OnClick="btnNuevo_Click"
                                        Text="Nuevo Asentamiento" CausesValidation="False" />
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                        </table>
            ...
            <asp:Panel ID="pnl" runat="server" class="formPanel">
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="lbl_titulo" runat="server" CssClass="textModalTitulo2" Text="Alta o Edición de Tipo de Asentamientos"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <br />
                            <asp:TextBox ID="txtdescripcion" TextMode="MultiLine" runat="server" CssClass="textMultiExtraGrande" MaxLength="100" placeholder="Descripción."></asp:TextBox>
                    ...
                    <tr>
                        <td>                            
                            <asp:CustomValidator ID="CustomValidator2" runat="server" ControlToValidate="txtdescripcion" CssClass="valida" ErrorMessage="Máximo 100 caracteres" ClientValidationFunction="validateLength" ValidationGroup="guardar"></asp:CustomValidator>
                        </td>
                    </tr>
                    <tr>
                        <td>
