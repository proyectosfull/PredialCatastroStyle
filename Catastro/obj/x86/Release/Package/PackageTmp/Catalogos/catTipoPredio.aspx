<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="catTipoPredio.aspx.cs" Inherits="Transito.Catalogos.catTipoPredio" %>
        ...
        <ContentTemplate>
            <table cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td style="height: 60px;">
                        <asp:Label ID="Label1" runat="server" Text="Tipo Predios" CssClass="letraTitulo"></asp:Label></td>
                </tr>
                <tr>
                    <td style="height: 2px">
                        <hr />
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td>
                                    ...
                                    <asp:Button ID="btnNuevoTipo" runat="server" OnClick="btnNuevo_Click"
                                        Text="Nuevo Tipo de Predio" CausesValidation="False" />
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                        </table>
            ...
            <asp:Panel ID="pnl" runat="server" class="formPanel">
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="lbl_titulo" runat="server" CssClass="textModalTitulo2" Text="Alta o Edición Tipos de Predios"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="lblDesc" runat="server" Text="Descripción:" CssClass="letraMediana"></asp:Label>
                            <br />
                            <asp:TextBox ID="txtDescripcion" runat="server" CssClass="textGrande" MaxLength="20" placeholder="Descripción."></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="valida" ControlToValidate="txtDescripcion" ErrorMessage="*" SetFocusOnError="True" ValidationGroup="guardar"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td>
