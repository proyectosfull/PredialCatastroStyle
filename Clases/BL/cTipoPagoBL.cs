...
namespace Clases.BL
{
	 ...
	 public class cTipoPagoBL
	 {
        ...
        public int GetByClave(string clave)
        {
            ...
            {
                new Utileria().logError("cTipoPago.GetByConstraint.Exception", ex, "--Parámetros clave:" + clave);
            }
            return obj.Id;
        }
        ...
        public cTipoPago GetTipoPagoByClave(string clave)
         {
             ...
             {
                 new Utileria().logError("cTipoPagoBL.GetByClave.Exception", ex , "--Parámetros clave:" + clave);
             }
             return obj;
         }
        ...
        public string  GetByTipoPagobyID(int  id)
        {
            ...
            {
                new Utileria().logError("cTipoPagoBL.GetByClave.Exception", ex, "--Parámetros id:" + id.ToString());
            }
            return obj.Clave;
        }
